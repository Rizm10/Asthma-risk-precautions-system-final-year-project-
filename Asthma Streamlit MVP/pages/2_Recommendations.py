...
# Remove disclaimer from function output (already shown above)
...
# FIX: no Styler (prevents crash)
st.dataframe(df, use_container_width=True)

# Explicit dominant factor instead of styling
st.caption(f"Dominant factor: {dominant.capitalize()}")
...
st.markdown("- Asthma + Lung UK: https://www.asthmaandlung.org.uk/")
